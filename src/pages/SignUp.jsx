...
export default function SignUp() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      addToast("Registracija / Prijava uspješna", "success");
      setSuccess(true);
    } catch (error) {
      ...
      <div style="position:relative;z-index:2;width:100%;max-width:440px;animation:scaleIn 0.35s ease;">
        ...
        <Show when={success()}>
          <div class="card-sb" style="padding:2.5rem;text-align:center;animation:scaleIn 0.3s ease;">
            ...
            <h2 style="font-family:var(--font-display);font-size:1.5rem;font-weight:700;margin:0 0 0.625rem;color:var(--text);">Račun je stvoren!</h2>
